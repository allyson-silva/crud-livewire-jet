<div>
    <x-button @click="$wire.set('modalCustomerCreate', true)">Novo</x-button>
    ...
    <x-dialog-modal wire:model.live="modalCustomerCreate" submit="save">
        ...
        <x-slot name="footer">
            ...
            <x-button  class="ml-3"    wire:click.self="save" wire:loading.attr="disabled" @click="$wire.set('modalCustomerCreate', false)">
                Salvar
            </x-button>
